...
export default function ScamReport({ assessment, mode }: { assessment: any; mode: string }) {
 ...
 async function submit(){setBusy(true);setError('');try{
   ...
   setReceipt(data);
 }catch(e){setError(e instanceof Error?e.message:'Report could not be saved.');}finally{setBusy(false);}}
 ...
 return <section className="ps-card"><h2>Report a suspected scam</h2><p className="ps-muted">Create a demo case with a private sender PDF. A report does not automatically mark someone as a scammer.</p>
